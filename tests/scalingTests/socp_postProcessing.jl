...
data = JLD.load("./182602_23-13_socpScalingTest.jld")
resCost = data["resCost"]
resIter = data["resIter"]

cc =  ["#1f77b4" "#ff7f0e" "#2ca02c" "#d62728" "#9467bd" "#8c564b"]

PyPlot.figure(3,facecolor="white",figsize=(12,5))
...
PyPlot.savefig("/Users/Micha/Dropbox/Research/OSSDP/Notes/Scaling_experiments/figs/socp_rho.eps")
